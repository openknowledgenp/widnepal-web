...
- You need to install following  plugins "WP GraphQL", "Advanced custom fields", "WID Custom plugin" and "WID custom tags and categories plugin" then activate all plugins. (You can manage plugins from `/wordpress/wp-content/plugins`.)
